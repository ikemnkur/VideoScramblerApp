...
const generateBuyerMockData = () => {
  ...
  return [
    ...
    },
    {
      ...
      status: 'Completed',
      created_at: new Date(currentTime.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(), // 1 day ago
      ...
      <Paper sx={{
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <Typography sx={{ 
              color: transaction.transaction_type === 'Credit Purchase' ? '#2e7d32' : '#ffd700', 
              fontWeight: 700,
              fontSize: '1.1rem'
            }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <Chip 
              ...
              size="small"
              sx={{
                backgroundColor: transaction.transaction_type === 'Key Purchase' ? '#ffd700' : 
                               transaction.transaction_type === 'Credit Purchase' ? '#2e7d32' : '#f44336',
                color: '#000',
                fontWeight: 600
              }}
            />
          ...
          {transaction.payment_method && (
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <Typography sx={{ color: '#e0e0e0' }}>{transaction.payment_method}</Typography>
            </Box>
          )}
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <Chip 
              ...
              size="small"
              sx={{
                backgroundColor: transaction.status === 'Completed' ? '#2e7d32' : 
                               transaction.status === 'Processing' ? '#ff9800' : '#f44336',
                color: '#fff'
              }}
            />
          </Box>
...
const BuyerTransactions = () => {
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', backgroundColor: '#0a0a0a', minHeight: '100vh', p: 3 }}>
      ...
      >
        {/* Controls */}
        <Typography variant="h5" sx={{ fontWeight: 600, mb: 2, color: '#ffd700' }}>Your Purchase History</Typography>
                  ...
                  <TableCell>
                    <Chip
                      ...
                      sx={{
                        ...
                        height: { xs: 20, sm: 24 },
                        backgroundColor: t.transaction_type === 'Key Purchase' ? '#ffd700' : 
                                         t.transaction_type === 'Credit Purchase' ? '#2e7d32' : '#f44336',
                        color: '#000',
                        fontWeight: 600,
                        '& .MuiChip-label': {
                          px: { xs: 0.5, sm: 1 }
