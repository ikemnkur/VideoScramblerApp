...
-- First, let's check what type userData.id uses and match it
...
CREATE TABLE IF NOT EXISTS device_fingerprints (
    ...
    -- Foreign key to user (using BIGINT to match most common userData.id type)
    ...
    -- If your userData.id column matches BIGINT, you can optionally add:
